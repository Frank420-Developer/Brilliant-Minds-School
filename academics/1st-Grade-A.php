                    ...
                    <div class="grid grid-c3">
                        <div class="teacher-card">
                            <div class="img flex py-10">
                                <img class="w-10" src="<?= $host_name?>/assets/img/teacher1a.jpg" alt="">
                            </div>
                            <div class="teacher-name py-10">
                                <h3>Mr. Victor Alvarado</h3>
                            </div>
                            <div class="teacher-info py-10">
                                <h4>Maestro Guía 1° Grado</h4>
                                <p class="paragraph py-10"><a href="mailto:valvarado@brilliantmindshn.com">valvarado@brilliantmindshn.com</a></p>
                                <h5>Español - Ingles</h5>
                            </div>
                            <div class="btns">
