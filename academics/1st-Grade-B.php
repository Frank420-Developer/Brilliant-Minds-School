                    ...
                    <div class="grid grid-c3">
                        <div class="teacher-card">
                            <div class="img flex py-10">
                                <img class="w-10" src="<?= $host_name?>/assets/img/teacher1b.png" alt="">
                            </div>
                            <div class="teacher-name py-10">
                                <h3>Mrs. Yessica Carolina Padilla</h3>
                            </div>
                            <div class="teacher-info py-10">
                                <h4>Maestra Guía 1° Grado</h4>
                                <p class="paragraph py-10"><a href="mailto:valvarado@brilliantmindshn.com">ypadilla@brilliantmindshn.com</a></p>
                                <h5>Idioma: Español - Ingles</h5>
                            </div>
                            <div class="btns">
            ...
            <div class="w-10">
                <div class="horario">
                    <div class="title w-9">
                        ...
                        <div class="linea"></div>
                        <div class="img w-9">
                            <img class="w-10" src="<?= $host_name?>/assets/img/schedule1a.jpg" alt="">
                        </div>
                        <div class="linea"></div>
                    </div>
