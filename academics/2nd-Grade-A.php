                    ...
                    <div class="grid grid-c3">
                        <div class="teacher-card">
                            <div class="img flex py-10">
                                <img class="w-10" src="<?= $host_name?>/assets/img/teachera2.jpg" alt="">
                            </div>
                            <div class="teacher-name py-10">
                                <h3>Mr. Juan Fernando Ordoñez</h3>
                            </div>
                            <div class="teacher-info py-10">
                                <h4>Mestro Guía 2° Grado "A"</h4>
                                <p class="paragraph py-10"><a href="mailto:jordonez@brilliantmindshn.com">jordonez@brilliantmindshn.com</a></p>
                        ...
                        <div class="teacher-card">
                            ...
                            <div class="teacher-info py-10">
                                ...
                                <p class="paragraph py-10"><a href="mailto:ezelaya@brilliantmindshn.com.com">ezelaya@brilliantmindshn.com</a></p>
                                <h5>Español</h5>
                            </div>
                            <div class="btns">
                                <button class="btn btn-blue">AGENDAR CITA</button>
