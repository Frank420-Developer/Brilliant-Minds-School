                    ...
                    <div class="grid grid-c3">
                        <div class="teacher-card">
                            <div class="img flex py-10">
                                <img class="w-10" src="<?= $host_name?>/assets/img/teacher1grade3.jpg" alt="">
                            </div>
                            <div class="teacher-name py-10">
                                <h3>Ms. Sofia Medina</h3>
                            </div>
                            <div class="teacher-info py-10">
                                <h4>Mestro Guía 3° Grado</h4>
                                <p class="paragraph py-10"><a href="mailto:mmedina@brilliantmindshn.com">mmedina@brilliantmindshn.com</a></p>
