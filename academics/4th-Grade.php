                    ...
                    <div class="grid grid-c4 teachers-4">
                        <div class="teacher-card">
                            <div class="img flex py-10">
                                <img class="w-10" src="<?= $host_name?>/assets/img/teacher4grade1.jpg" alt="">
                            </div>
                            <div class="teacher-name py-10">
                                <a href="<?= $host_name?>/academics/mrs-walveska-ruiz.php"><h3 style="text-decoration: underline;">Mrs. Walveska Ruiz</h3></a>
                            </div>
                            <div class="teacher-info py-10">
                                <h4>Mestro Guía 4° Grado</h4>
                                <p class="paragraph py-10"><a href="mailto:wruiz@brilliantmindshn.com">wruiz@brilliantmindshn.com</a></p>
                        ...
                        <div class="teacher-card">
                            ...
                            <div class="teacher-name py-10">
                            <a href="<?= $host_name?>/academics/mrs-elsy-zelaya.php"><h3 style="text-decoration: underline;">Mrs. Elsy Zelaya</h3></a>
                            </div>
                            <div class="teacher-info py-10">
            ...
            <div class="w-10">
                <div class="horario">
                    <div class="title w-9">
                        ...
                        <div class="linea"></div>
                        <div class="img">
                            <img src="<?= $host_name?>/assets/img/schedule4.jpg" alt="" class="w-10">
                        </div>
                        <div class="linea"></div>
                    </div>
